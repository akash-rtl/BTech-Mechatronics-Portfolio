...
canvas_size = 800
drawable_size = 600  # Size of the drawable area
...
def display_recent_coordinates(data):
    ...
    for line in reversed(lines):
        if line.startswith("(R1,"):
            ...
            mapped_x = (x / 4.5) * drawable_size
            mapped_y = (y / 3.15) * drawable_size
            
            # Ensure mapped coordinates are within valid range (0-drawable_size)
            if 0 <= mapped_x <= drawable_size and 0 <= mapped_y <= drawable_size:
