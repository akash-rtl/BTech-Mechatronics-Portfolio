...
uint8_t broadcastAddress[] = {0x7C, 0x9E, 0xBD, 0x61, 0x99, 0x50};

//Room_1 - {0x84, 0xCC, 0xA8, 0x2D, 0x82, 0x4C}
//Room_2 - {0x7C, 0x9E, 0xBD, 0x61, 0x99, 0x50}
   ...
   int count = scanResults.getCount();
    ...
    for (int i = 0; i < count; i++) {
      ...
      if (device.haveName() && device.getName() == "BT05") {
        ...
        data = "( " + String(beacon_num) + ", " + address + ", " + String(rssi) + " )";
        //client.println(data);
